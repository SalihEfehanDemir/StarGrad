...
import { FaKey, FaClock, FaCoins, FaShieldAlt, FaRocket, FaBolt, FaUsers, FaStar, FaCheckCircle, FaArrowRight, FaGithub, FaTwitter, FaLinkedin } from 'react-icons/fa';
    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12 sm:py-16 md:py-20">
        <header className="text-center mb-16 sm:mb-20 md:mb-24">
          ...
          >
            Streamline your digital life with our comprehensive suite of productivity tools. 
            From password security to time management and financial tracking, we've got you covered.
          </motion.p>
          <motion.div
          ...
          >
            <Link 
              ...
              className="bg-brand-blue hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg shadow-glow-blue hover:shadow-glow-blue-hover transition-all duration-300 flex items-center"
            >
            ...
            <button 
              ...
              className="border border-white/20 hover:border-white/40 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300"
            >
              Learn More
            </button>
          </motion.div>
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-4">
            Essential Tools for Modern Life
          </h2>
          <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
            Everything you need to stay organized, secure, and productive in one place.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {tools.map((tool, index) => (
              ...
              >
                <Link 
                  to={tool.path} 
                  className="group block p-6 sm:p-8 bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl shadow-lg hover:shadow-2xl hover:border-white/20 transform hover:-translate-y-2 transition-all duration-300 h-full touch-manipulation"
                >
                  <div className="flex justify-center items-center mb-4">
                    {tool.icon}
                  </div>
                  <h5 className="mb-2 text-xl sm:text-2xl font-bold tracking-tight text-center text-white">{tool.name}</h5>
                  <p className="font-normal text-gray-400 text-center text-sm sm:text-base">{tool.description}</p>
                </Link>
              </motion.div>
            ))}
          </div>
